...
export const todoOutput = [
  ...
  "  [ ] write credential isolation — puddles-runtime-write enterprise app",
  "  [ ] script library — curator promotion, validated templates",
  "  [ ] inline keyboard buttons for telegram (one-tap approve)",
